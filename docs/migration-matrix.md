...
| `e3smv3_g6_1p5k_hilla` | `e3smv3_g6_1p5k_hilla` | netcdf (unchanged; never zarrified — the hub holds the original CDF-5 tree under variable/gn/<version>/, opened via netCDF4 with a temporary local download; maintainer decision 2026-08-31) | pending_verification | {'table': 'Amon', 'variable': 'T', 'ensemble': 'v3.LR.ssp245.g6_hilla.sai.0101'} | {'table': 'Amon', 'variable': 'T', 'ensemble': '0101'} |
