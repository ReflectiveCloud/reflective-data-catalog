...
- UKESM's old `time=` kwarg is removed (the Zarr entries use CMOR tables); `table='AMON'` / `variable='T'`-style NetCDF vocabulary changed with the Zarr switches — see `docs/migration-matrix.md`.
